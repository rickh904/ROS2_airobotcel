...
class manipulatorController(Node):
    def __init__(self, node_name):
        ...
        # TIP: Controleer in je URDF of dit "link_base" of "base_link" moet zijn
        ...
        # TIP: Controleer de spelling van "manipuation" (zonder l) in je werkelijke bestandsnaam
    ...
    def move_to_tf(self, from_frame: str, to_frame: str):
        try:
            ...
            self.get_logger().warning(f"Could not transform {to_frame} to {from_frame}: {ex}")
    ...
    def execute_app(self):
        ...
        rotation = (1.0, 0.0, 0.0, 0.0)  # Controleer of je helper [w,x,y,z] of [x,y,z,w] verwacht
        self.move_to_pose(translation, rotation)
